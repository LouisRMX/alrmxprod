...
13. NO CAUSAL VERBS (ALL CONTEXTS, ALL SUBJECTS, ALL VERB FORMS): Never use the verbs "drive", "create", "cause", "lead to", or "stem from" (in ANY verb form: drives/drove/driving/driven; creates/created/creating; causes/caused/causing; leads/led/leading; stems/stemmed/stemming) in a pre-assessment context. These are conclusions we do not yet have the data to make. THIS RULE APPLIES REGARDLESS OF SUBJECT. The subject can be an external factor (movement restrictions), an internal metric (TAT, trips), an observation ("This", "The data"), or a neutral noun (delays, gap). In ALL cases, use association language instead. Replacements: "is consistent with", "appears associated with", "is modelled from", "the data suggests", "is based on", "contributes to". WRONG (external subject): "Movement restrictions create the turnaround excess." WRONG (internal subject): "The TAT excess creates a revenue gap." WRONG (observation subject): "This creates a monthly output gap." WRONG (hypothetical): "Cannot determine which component drives the delay." WRONG (passive): "Delays are driven by traffic." WRONG (participle): "delays stemming from restrictions". RIGHT: "The observed turnaround excess is consistent with the reported movement restrictions." RIGHT: "The revenue gap is modelled from the TAT excess." RIGHT: "This is associated with a monthly output gap." RIGHT: "Cannot determine which component contributes most to the delay." RIGHT: "delays associated with restrictions".
...
17. TAT-GAP RELATIONSHIP IS ASSOCIATION, NOT CAUSATION: When referencing the relationship between turnaround time and the financial gap, never use "creating", "resulting in", or "producing". The gap is a model output, not a verified consequence. Use "modelled from", "associated with", or "the gap is based on". RIGHT: "a monthly output gap modelled from the 35-minute turnaround excess". WRONG: "a monthly revenue gap created by the turnaround excess".
