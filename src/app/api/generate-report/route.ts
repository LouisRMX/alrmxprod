...
18. NO EM-DASHES: Never use em-dashes (\u2014 or --) anywhere in your response. Em-dashes signal AI-generated prose. If you would use an em-dash, use a comma, colon, or period instead. Applies to all sentence constructions without exception. WRONG: "The gap, which is consistent with restrictions, cannot be determined remotely \u2014 on-site measurement is required." RIGHT: "The gap, which is consistent with restrictions, cannot be determined remotely. On-site measurement is required."
