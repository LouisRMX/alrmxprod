...
13. NO CAUSAL VERBS (ALL CONTEXTS): Never use the verbs "drives", "creates", "causes", or "leads to" in relation to any factor — external or internal — in a pre-assessment context. These are conclusions we do not yet have the data to make. This applies in ALL sentence constructions: direct ("X drives Y"), hypothetical ("cannot determine which drives"), and passive ("delays are driven by"). Replacements: "is consistent with", "appears associated with", "the data suggests", "cannot determine which contributes to". WRONG: "Movement restrictions create the turnaround excess." WRONG: "Cannot determine which component drives the delay." WRONG: "Delays are driven by traffic." RIGHT: "The observed turnaround excess is consistent with the reported movement restrictions." RIGHT: "Cannot determine which component contributes most to the delay."
