...
const DEMO_PLANTS: PlantCardData[] = [
  // ── Core 3 (always shown) ── recovered: $60k → $79k ─────────────────────
  { id: 'dp-1',  name: 'Al-Noor Riyadh North', country: 'SA', assessmentHref: '/demo', assessment: { id: 'demo',    phase: 'onsite',   overall: 68, scores: { prod: 82, dispatch: 48, logistics: 71, fleet: 71, quality: 70 }, bottleneck: 'Dispatch',    constraintDetail: '32 min order-to-dispatch · target 15 min', ebitda_monthly: 115000, report_released: true,  trackingWeek: 7,   recoveredMonthly: 60000, trackingImprovement: { turnaroundDelta: 23, dispatchDelta: 15, weekOf: 7, weekTotal: 12 } } },
  { id: 'dp-2',  name: 'Al-Noor Riyadh East',  country: 'SA', assessmentHref: '/demo', assessment: { id: 'demo-2',  phase: 'onsite',   overall: 54, scores: { prod: 68, dispatch: 34, logistics: 52, fleet: 52, quality: 61 }, bottleneck: 'Dispatch',    ebitda_monthly: 103000, report_released: false, trackingWeek: null, recoveredMonthly: 19000 } },
  ...
  // ── Extended 10 ── recovered: $79k → $128k ───────────────────────────────
  { id: 'dp-4',  name: 'Al-Noor Jeddah',        country: 'SA', assessmentHref: '/demo', assessment: { id: 'demo-4',  phase: 'complete', overall: 83, scores: { prod: 88, dispatch: 79, logistics: 85, fleet: 85, quality: 80 }, bottleneck: null,           ebitda_monthly: 14000,  report_released: true,  trackingWeek: 13,  recoveredMonthly: 11000 } },
  { id: 'dp-5',  name: 'Al-Noor Al Khobar',     country: 'SA', assessmentHref: '/demo', assessment: { id: 'demo-5',  phase: 'onsite',   overall: 61, scores: { prod: 74, dispatch: 65, logistics: 59, fleet: 59, quality: 47 }, bottleneck: 'Quality',      ebitda_monthly: 54000,  report_released: false, trackingWeek: 3,   recoveredMonthly: 9000  } },
  { id: 'dp-6',  name: 'Al-Noor Makkah',        country: 'SA', assessmentHref: '/demo', assessment: { id: 'demo-6',  phase: 'complete', overall: 78, scores: { prod: 72, dispatch: 81, logistics: 83, fleet: 83, quality: 77 }, bottleneck: 'Production',   ebitda_monthly: 36000,  report_released: true,  trackingWeek: 11,  recoveredMonthly: 22000 } },
  ...
  { id: 'dp-8',  name: 'Al-Noor Jubail',        country: 'SA', assessmentHref: '/demo', assessment: { id: 'demo-8',  phase: 'complete', overall: 88, scores: { prod: 91, dispatch: 86, logistics: 89, fleet: 89, quality: 86 }, bottleneck: null,           ebitda_monthly: 9000,   report_released: true,  trackingWeek: 13,  recoveredMonthly: 7000  } },
  ...
  // ── Extended 20 ── recovered: $128k → $169k ──────────────────────────────
  ...
  { id: 'dp-12', name: 'Al-Noor Taif',          country: 'SA', assessmentHref: '/demo', assessment: { id: 'demo-12', phase: 'onsite',   overall: 72, scores: { prod: 80, dispatch: 74, logistics: 69, fleet: 69, quality: 66 }, bottleneck: 'Quality',      ebitda_monthly: 41000,  report_released: true,  trackingWeek: 5,   recoveredMonthly: 12000 } },
  ...
  { id: 'dp-15', name: 'Al-Noor Hail',          country: 'SA', assessmentHref: '/demo', assessment: { id: 'demo-15', phase: 'complete', overall: 81, scores: { prod: 85, dispatch: 78, logistics: 83, fleet: 83, quality: 79 }, bottleneck: null,           ebitda_monthly: 19000,  report_released: true,  trackingWeek: 13,  recoveredMonthly: 14000 } },
  ...
  { id: 'dp-19', name: 'Al-Noor Abha',          country: 'SA', assessmentHref: '/demo', assessment: { id: 'demo-19', phase: 'onsite',   overall: 76, scores: { prod: 83, dispatch: 77, logistics: 72, fleet: 72, quality: 71 }, bottleneck: 'Quality',      ebitda_monthly: 28000,  report_released: true,  trackingWeek: 9,   recoveredMonthly: 15000 } },
