...
export const LOG_STRINGS = {
  ...
  'live.add': 'Add',
  'live.current_plant': 'Site',
  'live.process': 'Measuring process',
  'live.full_cycle_option': 'Full cycle (all 9 stages)',
  'live.start_stage_timer': 'Start {stage} timer',
  ...
  'live.mix_type': 'Cement mix',
  'live.choose_mix': 'Choose mix',
  'live.add_mix_type_placeholder': 'e.g. 350, B40',
  'live.cement_type': 'Cement type',
  'live.load_m3': 'Loading size for truck',
  'live.choose_loading_size': 'Choose loading size m³',
  'live.choose_batching_unit': 'Choose batching unit',
  ...
  'token.helper_name_label': 'Helper name (shown to the helper, locks the measurer)',
  'token.helper_name_placeholder': 'e.g. Ali, Mohamed, Hany',
  'token.note_label': 'Note (admin-only, never shown to helper)',
  'token.note_placeholder': 'Optional context: shift, phone owner, etc.',
  'token.name_required': 'Helper name is required.',
...
export const LOG_STRINGS_AR: Record<LogStringKey, string> = {
  ...
  'live.add': 'إضافة',
  'live.current_plant': 'الموقع',
  'live.process': 'العملية المقاسة',
  'live.full_cycle_option': 'دورة كاملة (9 مراحل)',
  'live.start_stage_timer': 'بدء مؤقت {stage}',
  ...
  'live.mix_type': 'خلطة الإسمنت',
  'live.choose_mix': 'اختر الخلطة',
  'live.add_mix_type_placeholder': 'مثل 350، B40',
  'live.cement_type': 'نوع الإسمنت',
  'live.load_m3': 'حجم تحميل الشاحنة',
  'live.choose_loading_size': 'اختر حجم التحميل م³',
  'live.choose_batching_unit': 'اختر وحدة الخلط',
  ...
  'token.helper_name_label': 'اسم المساعد (يظهر له، ويُثبت اسم المقيس)',
  'token.helper_name_placeholder': 'مثل علي، محمد، هاني',
  'token.note_label': 'ملاحظة (للمشرف فقط، لا تظهر للمساعد)',
  'token.note_placeholder': 'سياق اختياري: الوردية، صاحب الهاتف، إلخ.',
  'token.name_required': 'اسم المساعد مطلوب.',
