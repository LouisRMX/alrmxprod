...
export const LOG_STRINGS_AR: Record<LogStringKey, string> = {
  // Field header
  'field.date': 'التاريخ',
  'field.share_capture_link': 'مشاركة رابط التسجيل',
  'field.weekly_briefing': 'التقرير الأسبوعي',
  'field.logged_trips': 'الرحلات المسجلة',

  // Sub-tabs
  'tab.live': 'مباشر',
  'tab.diagnostics': 'التشخيص',
  'tab.interventions': 'التدخلات',
  'tab.review': 'المراجعة',
  'tab.manual': 'يدوي',
  'tab.upload': 'رفع',
  'tab.audio': 'صوت',
  ...
  // Sync status
  'sync.online_all_synced': 'الجميع متزامن',
  ...
  'live.no_active_trips': 'لا توجد رحلات نشطة. اضغط "بدء رحلة جديدة" عند دخول الشاحنة طابور المصنع.',
  ...
  // Stage hints
  'stage.hint.plant_queue': 'في انتظار الدخول إلى حوض التحميل',
  'stage.hint.loading': 'الخلط وملء الخلاطة',
  ...
  'stage.hint.washout': 'تنظيف الخلاطة بعد الصب',
  'stage.hint.transit_back': 'الشاحنة تعود إلى المصنع',

  // Stage next action buttons
  'stage.next.plant_queue': 'بدء التحميل',
  'stage.next.loading': 'مغادرة المصنع',
  'stage.next.transit_out': 'الوصول إلى الموقع',
  'stage.next.site_wait': 'بدء الصب',
  'stage.next.pouring': 'انتهاء الصب',
  'stage.next.washout': 'مغادرة الموقع',
  'stage.next.transit_back': 'العودة إلى المصنع · إكمال الرحلة',
  ...
  'review.discard_trip': 'إلغاء الرحلة',
  ...
  'reviewq.auto_flagged': 'معلم تلقائياً',
  'reviewq.statistical_outlier': 'قيمة شاذة إحصائياً',
  'reviewq.total_tat': 'الوقت الكلي للدورة',
  'reviewq.min': 'دقيقة',
  ...
  'interv.metric_dispatch': 'وقت الإرسال',
  ...
  'interv.title_placeholder': 'مثال: تضييق نافذة الإرسال من ٢٥ إلى ١٥ دقيقة',
  ...
  'interv.description_placeholder': 'ما الذي تغير وما الأثر المتوقع (مثال: متوقع -١٠ دقائق TAT بحلول الأسبوع الرابع)',
  ...
  // Weekly briefing
  'brief.button': 'التقرير الأسبوعي',
  'brief.title': 'التقرير الأسبوعي',
  ...
  'diag.range': 'النطاق',
  'diag.today': 'اليوم',
  'diag.last_7': 'آخر ٧ أيام',
  'diag.last_30': 'آخر ٣٠ يوماً',
  'diag.all': 'الكل',
  'diag.complete': 'مكتمل',
  'diag.partial': 'جزئي',
  ...
  'diag.measured_by': 'قاس بواسطة',
  'diag.expected_vs_measured': 'المُبلَّغ مقابل المُقاس TAT',
  ...
  'diag.log_3_trips': 'سجل ٣ رحلات مكتملة على الأقل لمقارنة TAT المُقاس بافتراضات التقييم المسبق.',

  // Field capture token modal
  'token.button': 'مشاركة رابط التسجيل',
  'token.title': 'روابط التسجيل',
  ...
  'token.days_7': '٧ أيام (أسبوع في الموقع)',
  'token.days_30': '٣٠ يوماً',
  'token.days_60': '٦٠ يوماً',
  'token.days_90': '٩٠ يوماً (تتبع)',
  'token.days_120': '١٢٠ يوماً',
  'token.days_180': '١٨٠ يوماً',
  ...
  'token.copy': 'نسخ',
  'token.revoke': 'إلغاء',
  'token.revoke_confirm': 'إلغاء هذا الرابط؟ أي شخص يستخدمه سيفقد الوصول فوراً.',
